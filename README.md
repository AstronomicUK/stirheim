...
Status (2026-09-03): **Phase 0 complete.** Live at https://lively-conkies-1e412a.netlify.app
(Netlify, auto-deploys from `main`; rename to stirheim.netlify.app pending). See `docs/FRAMEWORK.md` for the full plan and
