...
- Core Awakening now has migration 089, both-owner notifications/cards, exact retained profile/kit, duplicate and report-reversal safeguards, eight database tests and a real two-owner mobile journey. Multiple eligible recipients still await Tom’s allocation decision; broader #229 remains incomplete.
- Core Captured has migration 090 and two-player proposals, notifications, report dependencies and reversal. Codex review requested further exact equipment/condition/group/advance validation; it is not yet accepted for release.
- Pirate Kidnapped has a tested pure resolver, original/edited dice logs and inherited Swabbie skill consumers. Claude is implementing durable per-casualty offers and independent player dice; this is not a completed recruitment workflow.
