...
| Ogre / Pit Fighters | Existing generic captive framework is available; Pit Fighter no-sale restriction is enforced in all menus/validators | Their bespoke aftermath is not implemented; questions are in MORNING-RULINGS-2026-09-13.md |
