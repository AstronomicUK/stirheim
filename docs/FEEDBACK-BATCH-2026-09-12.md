...
Latest broad evidence: **2,421 ordinary tests across 204 files**, TypeScript and build pass through the rescue corrections. The latest full API run passes **319/319 across 56 files** through migration 124. The earlier leaked-fixture cleanup issue is fixed. Migration 124 additionally passes all 15 forced-capture API tests. Engine and Slaaneshi mobile flows are connected and verified, including player consent and exact kit. Nothing in this batch has been deployed.
