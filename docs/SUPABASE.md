...
function that is not there yet. Migration 24 (Phase 21: three house-rule switches in the settings default), migration 23 (Phase 20: `map_tolls`, `pay_map_toll`), migration 22 (Phase 19: `matches.district_id`, `set_match_district`, `map_adjustments`, the mapCampaign
