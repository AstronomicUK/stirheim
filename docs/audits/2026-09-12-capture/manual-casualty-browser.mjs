...
try {
 ...
 await p.getByRole('button',{name:'Not sure, skip',exact:true}).click();
 ...
 console.log('PASS: mobile mixed casualty tally adds one manual casualty to one logged casualty, survives reload and removes only the manual casualty.');
