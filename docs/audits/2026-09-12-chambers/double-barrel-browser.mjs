...
try {
 ...
 console.log('PASS: select both barrels inside roller, miss consumes two chambers on selected gun only, reload persists, next phase reloads one barrel, mini roster reflects all states, no overflow/page errors.');
