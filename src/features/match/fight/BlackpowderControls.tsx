...
import { correctBlackpowderShot, recordMisfireDie, type BattleLiveState, type BlackpowderShot } from '../../../domain'
import { Button, DieField, SelectField, TextField } from '../../../ui'
export function BlackpowderControls({ sheet, warriorId, weaponKey, slots, slot, setSlot, blocked, readOnly, edit }: {
...
function PendingMisfire({ shot, readOnly, edit }: { shot: BlackpowderShot; readOnly: boolean; edit?: (fn: (s: BattleLiveState) => BattleLiveState) => void }) {
  ...
  return <div className="flex flex-col gap-2">
    <p>Finish the saved misfire after closing or reloading the roller. A KA-BOOM hit or BOOM self-hit from this recovery control must be resolved at the table.</p>
