...
function oddsNotes(setup: FightSetup, weapons: WeaponOdds[]): string[] {
  ...
  for (const w of weapons) {
    ...
    if (w.input.misfireEnhanced) notes.push('Swivel Gun: a natural 1 to hit rolls on the mandatory misfire table. Its 6 result hits at +1 Strength, included in these target odds. Self-hit damage, weapon destruction, jamming and reload consequences must currently be recorded at the table.')
