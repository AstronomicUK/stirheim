...
function oddsNotes(setup: FightSetup, weapons: WeaponOdds[]): string[] {
  ...
  for (const w of weapons) {
    ...
    if (w.input.misfireEnhanced) notes.push('Swivel Gun: a natural 1 to hit rolls on the mandatory misfire table. Its 6 result hits at +1 Strength, included in these target odds. The Battle Sheet records firing, jamming and reload delays. Resolve self-hit damage and permanent weapon removal at the table.')
