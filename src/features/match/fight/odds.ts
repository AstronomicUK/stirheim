...
function oddsNotes(setup: FightSetup, weapons: WeaponOdds[]): string[] {
  ...
  for (const w of weapons) {
    ...
    if (w.input.automaticHitReason === 'volatileBackfire') notes.push('Cathayan Candles exploded in the thrower’s hand: roll to wound this model at Strength 6. No new to-hit or ignition roll; resolve its own saves and injuries.')
