import type { SpecialKillXp } from './specialKillXp'
...
export interface ExplorationDraft {
  enginePrisonerRoll?: number | null
  enginePrisonerOriginalRoll?: number | null
