...
export function HiredRosterRepairCard({detail,canEdit}:{detail:WarbandDetail;canEdit:boolean}) {
 ...
 if(!canEdit||(!repairs.length&&!missingScouts))return null
