...
export const SCENARIO_REWARD_ITEMS: Item[] = [
  {id:'symbol_of_the_order_of_freetraders',name:'Symbol of the Order of Freetraders',category:'misc',price:{base:null,text:'Not listed'},availability:{kind:'special',text:'Exploration: Merchant’s House doubles'},description:'A Hero in possession of this symbol gains Haggle: once per post-battle sequence, deduct 2D6 gc from the price of a single item, to a minimum of 1 gc. It is found instead of gold when the Merchant’s House roll is a double.',specialRules:[],scenarioRewardOnly:true,source:{publication:'Mordheim Rulebook',file:'03-campaigns-magic-optional-rules.md:884-888'}},
