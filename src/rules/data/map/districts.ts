...
export const MAP_DISTRICTS: MapDistrict[] = [
  ...
  { id: "temple-of-morr", name: "Temple of Morr", x: 29.95, y: 72.55, scale: 0.78, advantage: "If a Hero's injury result is 11-15 Dead on the Heroes' Serious Injures Chart, roll a D6. On a 5+, the result becomes 41-55 Full Recovery instead.", abundance: false, hard: false, gate: false, connections: ["the-cemetery", "executioners-square", "south-gate"] },
  { id: "the-cemetery", name: "The Cemetery", x: 25.5, y: 71.15, scale: 0.74, advantage: "Undead warband: Zombies cost 10 gc to hire and Ghouls cost 30 gc to hire. Other warbands: The warband is immune to Fear, and Terror is treated as Fear", abundance: true, hard: true, gate: false, connections: ["the-gaol", "executioners-square", "temple-of-morr"] },
  ...
  { id: "poor-quarter", name: "Poor Quarter", x: 58.1, y: 71.3, scale: 1.27, advantage: "Roll one extra dice in the Exploration Procedure.", abundance: false, hard: true, gate: false, connections: ["south-gate", "amphitheatre", "the-pit", "clock-tower"] },
  ...
  { id: "south-gate", name: "South Gate", x: 48.3, y: 74.2, scale: 1.07, advantage: "1/2 price to hire Luthor Wolfenbaum. A hero sent to look for Luthor automatically finds him.", abundance: false, hard: false, gate: true, connections: ["temple-of-morr", "the-rock", "amphitheatre", "poor-quarter"] },
