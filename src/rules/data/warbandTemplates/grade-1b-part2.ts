    ...
    equipmentLists: [
      ...
      },
      {
        ...
        meleeWeapons: [
          ...
          { name: `Hammer`, cost: `3 gc` },
          { name: `Axe`, cost: `5 gc` },
          { name: `Dwarf Axe (Dwarf Trollslayer only)`, cost: `15 gc`, onlyUnitTemplateIds: ["pit_fighters_troll_slayer"] },
          { name: `Sword`, cost: `10 gc` },
          { name: `Flail`, cost: `15 gc` },
        ...
        missileWeapons: [],
        armour: [
          { name: `Light armour (Ogre only)`, cost: `20 gc`, onlyUnitTemplateIds: ["pit_fighters_ogre"] },
          { name: `Helmet (Ogre only)`, cost: `10 gc`, onlyUnitTemplateIds: ["pit_fighters_ogre"] },
        ],
      },
    ],
    heroTemplates: [
