    ...
    equipmentLists: [
      {
        ...
        meleeWeapons: [
          ...
          { name: "Spear (Pilgrims only)", cost: "10 gc", onlyUnitTemplateIds: ["pilgrims"] },
          { name: "Halberd (Pilgrims only)", cost: "10 gc", onlyUnitTemplateIds: ["pilgrims"] },
          { name: "Double-handed weapon", cost: "15 gc" },
          { name: "Flail", cost: "15 gc" },
          { name: "Morning star", cost: "15 gc" },
          { name: "Lance (Knights only)", cost: "20 gc", onlyUnitTemplateIds: ["paragon", "gallant", "redeemed_knights"] },
        ],
        missileWeapons: [{ name: "Bow (Pilgrims only)", cost: "10 gc", onlyUnitTemplateIds: ["pilgrims"] }],
        armour: [
          { name: "Shield", cost: "5 gc" },
          { name: "Helmet", cost: "10 gc" },
          { name: "Light armour", cost: "20 gc" },
          { name: "Heavy armour (Knights only)", cost: "50 gc", onlyUnitTemplateIds: ["paragon", "gallant", "redeemed_knights"] },
        ],
      },
      {
        id: "archer_equipment",
        ...
        meleeWeapons: [
          ...
          { name: "Axe", cost: "5 gc" },
          { name: "Sword", cost: "10 gc" },
          { name: "Spear (Esquiresses only)", cost: "10 gc", onlyUnitTemplateIds: ["esquiresses"] },
        ],
        missileWeapons: [
          { name: "Bow", cost: "10 gc" },
