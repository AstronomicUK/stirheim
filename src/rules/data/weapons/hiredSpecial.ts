...
export const HIRED_SPECIAL_WEAPONS: Weapon[] = [
 {id:'norse_rune_staff',name:'Rune Staff',type:'melee',strength:'user',critCategory:'bludgeoning',concussion:true,special:[],rangedProfile:null},
 {id:'priest_hammer_of_sigmar',name:'Hammer of Sigmar',type:'melee',strength:'user',critCategory:'bludgeoning',concussion:true,special:[],rangedProfile:null},
 {id:'maximilian_holy_weapon',name:'Maximilian’s Holy Weapon',type:'melee',strength:'user',strengthBonus:2,critCategory:'bladed',concussion:false,vsTraits:{traits:['undead','possessed','maximilian_holy_target'],toWound:1},special:['twoHanded','strikesLast'],rangedProfile:null},
