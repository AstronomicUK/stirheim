...
export const MELEE_WEAPONS: Weapon[] = [
  ...
  { id: "cathayan_longsword", name: "Cathayan Longsword", type: "melee", strength: "user", critCategory: "bladed", concussion: false, parry: true, isSword: true, saveModifier: 1, wsBonus: 1, initiativeModifier: 1, special: ["mastercraftedPlus1WsAndI", "cuttingEdge"], rangedProfile: null },
  ...
  { id: "chain_sticks", name: "Chain Sticks", type: "melee", strength: "user", critCategory: "bludgeoning", concussion: false, firstTurnBonusAttacks: 2, special: ["plus2AttacksFirstTurn", "twoHanded"], rangedProfile: null },
  ...
  // Kept for rosters that hold a Dark Elf Blade with no base weapon noted: treated as an upgraded sword (Parry kept).
  { id: "dark_elf_blade", name: "Dark Elf Blade (sword)", type: "melee", strength: "user", critCategory: "bladed", concussion: true, isSword: true, parry: true, critTableRollModifier: 1, special: ["critTablePlus1", "upgradedSwordOrDagger"], rangedProfile: null },
  ...
  { id: "ladle", name: "Ladle", type: "melee", strength: "user", critCategory: "bludgeoning", concussion: false, ignoresArmourSaveExceptShield: true, special: ["noArmourSaveExceptShieldsOrSkills", "disarmOnNatural6"], rangedProfile: null },
  { id: "lance", name: "Lance", type: "melee", strength: "user", strengthBonus: 2, strengthBonusMountedChargeOnly: true, critCategory: "thrusting", concussion: false, special: ["strengthBonusOnlyWhenChargingMounted", "mountedOnly"], rangedProfile: null },
  ...
  { id: "misericordia", name: "Misericordia", type: "melee", strength: "user", critCategory: "bladed", concussion: false, saveModifier: -1, toWoundHighestOf2D6VsKnockedDown: true, special: ["armourPiercingVsKnockedDown"], rangedProfile: null },
  ...
  // Ogre Club: Crushing Attack (-1 enemy save, +1 S for the parry check) applies only when used two-handed.
  { id: "ogre_club", name: "Ogre Club", type: "melee", strength: "user", critCategory: "bludgeoning", concussion: true, saveModifier: 1, saveModifierTwoHandedOnly: true, special: ["crushingAttackParryStrengthPlus1"], rangedProfile: null },
  { id: "pike_merchant_caravans", name: "Pike (Merchant Caravans)", initiativeFirstTurnBonus: 1, type: "melee", strength: "user", critCategory: "thrusting", concussion: false, special: ["strikesFirstFirstTurn", "twoHanded"], rangedProfile: null },
  { id: "pike_tileans", name: "Pike (Tileans)", type: "melee", strength: "user", critCategory: "thrusting", concussion: false, maxAttacks: 1, special: ["strikesFirstFirstTurn", "twoHanded", "reach3Inches", "manSizedWielderOnly"], rangedProfile: null },
  ...
  { id: "sons_of_hashut_obsidian_weapon", name: "Sons of Hashut Obsidian Weapon (sword)", type: "melee", strength: "user", strengthBonus: 1, critCategory: "bladed", concussion: false, parry: true, isSword: true, initiativeModifier: -1, special: ["restrictedToSwordAxeOrHammerForm", "minus1Initiative"], rangedProfile: null },
  ...
  { id: "starblade", name: "Starblade", type: "melee", strength: "user", critCategory: "bladed", concussion: false, saveModifier: -1, parry: true, parryThreshold: 4, special: ["potentialParryOn4Plus"], rangedProfile: null },
