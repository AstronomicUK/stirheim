...
export const RANGED_AND_CREATURE_WEAPONS: Weapon[] = [
  ...
  { id: "crossbow_pistol", name: "Crossbow Pistol", type: "ranged", strength: 4, critCategory: "missile", concussion: false, special: ["usableInFirstRoundOfCloseCombatExtraMinus2ToHit"], rangedProfile: { shortRange: 5, maxRange: 10, shotsPerTurn: 1 } },
  ...
  { id: "repeater_crossbow", name: "Repeater Crossbow", type: "ranged", strength: 3, critCategory: "missile", concussion: false, multiShotToHitPenalty: 1, altFire: { label: "Single shot", shots: 1, toHitPenalty: 0, hint: "One shot with no penalty instead of two at -1." }, special: ["fireTwiceIsOptional"], rangedProfile: { shortRange: 12, maxRange: 24, shotsPerTurn: 2 } },
  ...
  { id: "ostlander_double_barrelled_hunting_rifle", name: "Ostlander Double-barrelled Hunting Rifle", type: "ranged", strength: 4, critCategory: "missile", concussion: false, saveModifier: 2, moveOrFire: true, special: ["prepareShotReloadEveryOtherTurn", "doubleBarrelledTwoHitsPerSuccessfulShot"], rangedProfile: { shortRange: 24, maxRange: 48, shotsPerTurn: 1 } },
  { id: "ostlander_double_barrelled_pistol", name: "Ostlander Double-barrelled Pistol", type: "ranged", strength: 4, critCategory: "missile", concussion: false, saveModifier: 2, special: ["prepareShotReloadEveryOtherTurnUnlessBrace", "doubleBarrelledTwoHitsPerSuccessfulShot", "usableInMelee"], rangedProfile: { shortRange: 3, maxRange: 6, shotsPerTurn: 1 } },
  ...
  { id: "repeater_handgun", name: "Repeater Handgun", type: "ranged", strength: 4, critCategory: "missile", concussion: false, saveModifier: 2, moveOrFire: true, multiShotToHitPenalty: 1, altFire: { label: "Single shot", shots: 1, toHitPenalty: 0, hint: "One shot with no penalty instead of three at -1." }, special: ["fireUpToThriceIsOptional", "experimentalBlackpowderRulesAlwaysOn", "slowReloadFullInactiveTurnToReload"], rangedProfile: { shortRange: 12, maxRange: 24, shotsPerTurn: 3 } },
  { id: "repeater_pistol", name: "Repeater Pistol", type: "ranged", strength: 4, critCategory: "missile", concussion: false, saveModifier: 2, multiShotToHitPenalty: 1, altFire: { label: "Single shot", shots: 1, toHitPenalty: 0, hint: "One shot with no penalty instead of three at -1." }, special: ["fireUpToThriceIsOptional", "experimentalBlackpowderRulesAlwaysOn", "quickReloadAlwaysAtLeastOneShot"], rangedProfile: { shortRange: 3, maxRange: 6, shotsPerTurn: 3 } },
