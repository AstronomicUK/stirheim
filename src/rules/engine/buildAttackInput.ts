...
export function buildAttackInput({ attacker, weapon, defender, context, customSkills = [], houseRules = defaultHouseRules() }: BuildAttackInputParams): AttackInput {
  ...
  return {
    ...
    automaticHits: weapon.special.includes("powderKegBlastHit") || weapon.special.includes("volatileSelfHit") || weapon.special.includes("mortarBlastHit") || weapon.special.includes("grapeShotHit") || (weapon.special.includes("blackpowderSelfHit") || weapon.special.includes("fireRecoveryHit")) || pigeonBlast || weapon.special.includes("autoHitLine16inLongBy1inWide") || weapon.type === "melee" && defender.WS === 0 || undefined,
    automaticHitReason: weapon.special.includes("powderKegBlastHit") ? "powderKegBlast" : weapon.special.includes("volatileSelfHit") ? "volatileBackfire" : weapon.special.includes("mortarBlastHit") ? "mortarBlast" : weapon.special.includes("grapeShotHit") ? "grapeShot" : (weapon.special.includes("blackpowderSelfHit") || weapon.special.includes("fireRecoveryHit")) ? weapon.special.includes("fireRecoveryHit") ? "fireRecovery" : "blackpowderExplosion" : pigeonBlast ? "pigeonBlast" : weapon.special.includes("autoHitLine16inLongBy1inWide") ? "blunderbussLine" : weapon.type === "melee" && defender.WS === 0 ? "zeroWeaponSkill" : undefined,
    ...
    critTriggerFaces: context.sharedCriticalUsed || (weapon.special.includes("blackpowderSelfHit") || weapon.special.includes("fireRecoveryHit")) || weapon.special.includes("noFurtherCritical") ? [] : critTriggerFaces,
    critTable,
