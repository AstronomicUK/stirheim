...
export const captureRuleName=(reason:'subjugator'|'man_catcher'|'cavalcade'|'slaaneshi_lock'|undefined)=>reason==='slaaneshi_lock'?'Slaaneshi Man-Catcher':reason==='cavalcade'?'Misericordia':reason==='man_catcher'?'Man-catcher':'Subjugator of Mankind'
