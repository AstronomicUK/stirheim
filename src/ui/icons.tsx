...
const PATHS: Record<IconName, IconArt> = {
  ...
  // #90: a coin purse — reads cleanly as "hired for money" at both 20px and blown up. Replaced the
  // sword-and-coin pick after Tom saw it live and didn't like it; a "purse + loose coins" variant
  // was tried and dropped too (the coins read as noise/blob at real size) — plain purse won out.
  hired: 'M8 3h8l-2 4H10zM9 7h6M9 9C7 11 4 14 4 17c0 3 3 4 8 4s8-1 8-4c0-3-3-6-5-8',
  ...
  characters: 'M12 12a4 4 0 100-8 4 4 0 000 8zM4 21c0-4 4-6 8-6s8 2 8 6M18 1l0.65 2.35L21 4l-2.35 0.65L18 7l-0.65-2.35L15 4l2.35-0.65z',
  ...
  cast: 'M12 22C6.5 22 3 18.8 3 14.5C3 11.5 5.2 8.8 5.5 6C7.5 7.3 8.3 9.4 8 11.5C11.2 9 12.1 5.3 11 2C15.5 4.5 17.1 8 16 11.5C18.2 10.8 19.3 9.4 19.5 7.5C20.7 10 22 12.3 21 15.8C20 19.5 16.8 22 12 22Z',
